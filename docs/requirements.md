...
| R11 | Initial native administrator approval; never retain password | Signed helper approval/revocation and XPC authorization tests | Five non-root cross-process cases and three listener-admission cases pass; native approval and privileged exchange open |
