...
| R11 | Initial native administrator approval; never retain password | Signed helper approval/revocation and XPC authorization tests | Eight non-root cases pass; native installation and authenticated root-helper status verified; first removal bug reproduced and corrected; cancellation and complete lifecycle open |
