...
| R10 | Homebrew installation, clean distribution and complete uninstall | Fresh install, upgrade, active-session removal and zap verification | Community helper lifecycle, bundled absent-helper cleanup and local cask style/audit/install/removal/reinstall/zap pass; download/upgrade/active Homebrew and latest-build cask lifecycle gates open |
